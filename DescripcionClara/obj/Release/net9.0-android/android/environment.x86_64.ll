...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x06001a61, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001a60, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x0eb7f7ea2cf715f4, ; from name: aot-DescripcionClara.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	}, ; 55
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x446ecbcb0472b37e, ; from name: DescripcionClara
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x49e711bcb6d97f0e, ; from name: aot-DescripcionClara.dll.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x527acfb2b74dd4db, ; from name: DescripcionClara.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x5c32119c9c40b61e, ; from name: libaot-DescripcionClara.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x648861c522b81ee8, ; from name: aot-DescripcionClara
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x9419acb72307d711, ; from name: libaot-DescripcionClara.dll.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xc8fb2b9ee227726d, ; from name: DescripcionClara.dll.so
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xdf3d8b7a9302e947, ; from name: libaot-DescripcionClara
		i64 u0x9419acb72307d711, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-DescripcionClara.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.tuempresa.descripcionclara\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-DescripcionClara.dll.so\00", align 16
